...
void Target::Init(int xPosInput, int yPosInput, int xVectorInput, int yVectorInput, int sizeInput, int speedInput, int colorRedInput, int colorGreenInput, int colorBlueInput)
{
